						...
						<div class="card-body">
							<div class="row">
								<div class="col-12">
									...
									<p>
										Obtenha os dados:
										<a href="https://www.mercadopago.com.br/developers/pt/api-docs/basics/authentication/">Clique Aqui !</a>
									</p>
								</div>
	...
	<div class="row">
		<div class="col-12">
			<form class="" action="" method="post">
				<div class="card">
					<div class="card-header">
						<h4 class="card-title text-info">Backup do Banco de Dados SQL</h4>
					</div>
					<div class="card-content">
						<div class="card-body">
							<div class="row">
								<div class="col-12 text-center">
									<p>
										Faça Download backup do banco de dados
									</p>
								</div>
								<div class="col-12 text-center">
									<fieldset class="form-group">
										<?php if(file_exists("../admin/pages/apis/$DirBackup/plus.sql")) { ?>
											<a class="btn btn-info" href="../admin/pages/apis/<?php echo $DirBackup;?>/plus.sql">Baixar Backup</a>
										<?php } else { ?>
