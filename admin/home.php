...
<head>
    ...
    <meta name="keywords" content="VPN SSHPLUS, VPN, SSH, Gratis, Registrar">
    <meta name="author" content="Crazy">
    <meta name="msapplication-TileColor" content="#FFFFFF">
    <meta name="theme-color" content="#FFFFFF">
    <title>SSHPLUS - PAINEL</title>
...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="false">
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto"><a class="navbar-brand" href="/admin/home.php">
                ...
                <h2 class="brand-text mb-0">SSHPLUS</h2>
            </a></li>
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" navigation-header"><span>NAVEGACAO PRINCIPAL</span>
            </li>
            ...
            <li class=" nav-item"><a href="#"><i class="ficon fal fa-greater-than-equal text-info"></i><span class="menu-title" data-i18n="Area VPN"> CONTAS SSH</span><span class="badge badge badge-info badge-pill float-right mr-2"><?php echo $contas_ssh; ?></span></a>
                <ul class="menu-content">
                    ...
                    <li><a href="?page=ssh/add_teste"><i class="ficon fad fa-clock"></i><span class="menu-item" data-i18n="Criar Teste"> Criar Teste SSH</span></a>
                    </li>
                    <li><a href="?page=ssh/online"><i class="ficon ficon fad fa-rocket"></i><span class="menu-item" data-i18n="SSH Online"> SSH Online</span></a></li>
            ...
            <div class="navbar-container content">
                <div class="navbar-collapse" id="navbar-mobile">
                  ...
                  <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon fad fa-rocket"></i><span class="badge badge-pill badge-success badge-up"><?php echo $total_acesso_ssh_online; ?></span></a>
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <div class="dropdown-header m-0 p-2">
                                    <h3 class="white"><?php echo $total_acesso_ssh_online; ?></h3><span class="notification-title">Usuários Conectados</span>
                                </div>
                            </li>
                            ...
                            <li class="dropdown-menu-footer"><a class="dropdown-item p-1 text-center" href="home.php?page=ssh/online">Ver todos</a></li>
                        </ul>
                    </li>
...
<footer class="footer footer-static footer-light">
    <center><p class="clearfix blue-grey lighten-2 mb-0">
        <span class="center">
            ...
            <a class="text-bold-800 grey darken-2" href="#" target="_blank">SSHPLUS </a></span>
        </span>
