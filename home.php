            ...
            <div class="navbar-header">
                <ul class="nav navbar-nav flex-row">
                    <li class="nav-item mr-auto"><a class="navbar-brand" href="home.php">
                        <img class="round" src="../app-assets/images/logo/logo.png" alt="icon" height="35" width="28" />
                ...
                <div class="navbar-wrapper">
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        <a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon fad fa-rocket"></i>
                            <span class="badge badge-pill badge-success badge-up"><?php echo $total_acesso_ssh_online; ?></span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <div class="dropdown-header m-0 p-2">
                                    <h2 class="white"><?php echo $total_acesso_ssh_online; ?> </h2><span class="notification-title">Usuários conectado</span>
                                </div>
                            </li>
