...
<head>
    ...
    <style media="screen">
        .fundodapagina{
            background: -webkit-linear-gradient(#7367F0, #7367F0);
        }
    </style>
</head>
<!-- END: Head-->
                            ...
                            <div class="col-lg-6 col-12 p-0">
                                <div class="card rounded-0 mb-0 px-2">
                                    <div class="card-header pb-1">
                                        ...
                                        <h4><i class="fa fa-linux"></i><b> SSHPLUS</b></h4>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body pt-1">
                                            <form action="validacao.php" method="post">
                                                ...
                                                <div class="form-group d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="text-right"><a data-toggle="modal" data-target="#myModal" id="to-recover" class="card-link primary">Esqueceu a senha?</a></div>
                                                </div>
                                                <!-- <a href="auth-register.html" class="btn btn-outline-primary float-left btn-inline">Registrar</a> -->
                                    ...
                                    <div class="login-footer">
                                        ...
                                        <center><a href="./admin" class="btn btn-outline-danger mr-1 mb-1 waves-effect waves-light"><i class="fa fa-user-circle" aria-hidden="true"></i></a></center>
                                            <div class="card-body">
                                                <p><b>SSHPLUS</b> &copy; <script> document.write(new Date().getFullYear())</script> Todos os direitos reservados.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
